 ...
 * Size: 96 px
 * Bpp: 4
 * Opts: --font .pio/libdeps/wt32-sc01-plus/lvgl/scripts/generators/built_in_font/Montserrat-Medium.ttf --size 96 --bpp 4 --format lvgl --lv-include lvgl.h --no-compress --range 0x20,0x2D,0x30-0x3A -o src/fonts/font_ms_96.c
 ******************************************************************************/
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t font_ms_96 = {
#else
lv_font_t font_ms_96 = {
#endif
